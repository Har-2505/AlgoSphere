...
function AdminUpload() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // Create a clean axios instance and strip ALL default headers & credentials to prevent CORS preflight checks
      const cleanAxios = axios.create({
        withCredentials: false
      });
      cleanAxios.defaults.headers.common = {};
      cleanAxios.defaults.headers.post = {};

      // Step 3: Upload directly to Cloudinary
      const uploadResponse = await cleanAxios.post(upload_url, formData, {
        headers: {
  ...
  return (
    <div className="max-w-md mx-auto p-6 text-base-content">
      <div className="card bg-base-100 shadow-xl border border-base-300">
        <div className="card-body">
          <h2 className="card-title text-2xl font-bold mb-4">Upload Video</h2>
